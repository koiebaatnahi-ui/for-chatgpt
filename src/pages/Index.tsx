      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="text-center animate-fade-in">
            {/* Logo (replaced with college logo from public/) */}
            <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-primary/10 mb-8">
              <img
                src="/college-logo.png"
                alt="Your College Name"
                className="p-3 bg-white/80 rounded-lg h-24 w-24 object-contain"
              />
            </div>
            ...
            <p className="max-w-2xl mx-auto text-lg text-muted-foreground mb-10">
              Welcome to <strong>Jagannath Barooah College</strong> Student Portal manage courses, attendance,
              and results easily for administrators, faculty and students.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="stat-card text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Complete operations for student records.
              </p>
            </div>
